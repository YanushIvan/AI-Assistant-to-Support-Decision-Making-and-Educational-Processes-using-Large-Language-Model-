...
Po spustení sa v~konzole zobrazí adresa servera. Predvolený port je nastavený v~\texttt{energy_chat/core/config.py}. V~aktuálnej konfigurácii je to port 8002. V~prehliadači otvorte adresu \texttt{http://localhost:8002} alebo port, ktorý ste nastavili.
...
\begin{figure}[ht]
	...
	\textit{thesis.in.latex/figures/model_select.png}}}
...
\begin{figure}[ht]
	\centering
	\fbox{\parbox[c][4cm][c]{0.85\textwidth}{\centering
	\textit{thesis.in.latex/figures/online.png}}}
...
\begin{figure}[ht]
	\centering
	\fbox{\parbox[c][4cm][c]{0.85\textwidth}{\centering
	\textit{thesis.in.latex/figures/question_template.png}}}
...
\begin{figure}[ht]
	\centering
	\fbox{\parbox[c][4cm][c]{0.85\textwidth}{\centering
	\textit{thesis.in.latex/figures/question_field.png}}}
...
\begin{figure}[ht]
	\centering
	\fbox{\parbox[c][4cm][c]{0.85\textwidth}{\centering
	\textit{thesis.in.latex/figures/send_button.png}}}
