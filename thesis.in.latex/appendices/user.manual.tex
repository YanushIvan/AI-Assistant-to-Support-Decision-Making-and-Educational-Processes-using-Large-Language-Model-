...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.85\textwidth]{figures/model_select.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.85\textwidth]{figures/online.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.85\textwidth]{figures/question_template.png}
	\caption{Tlačidlá s~rýchlymi návrhmi otázok.}
	\label{fig:question_template}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.85\textwidth]{figures/question_field.png}
	\caption{Vstupné pole pre zadanie otázky.}
	\label{fig:question_field}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.85\textwidth]{figures/send_button.png}
	\caption{Tlačidlo na odoslanie správy.}
	\label{fig:send_button}
\end{figure}
