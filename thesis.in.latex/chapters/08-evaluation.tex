...
Použité metriky pokrývajú kvalitu výstupov aj prevádzkovú použiteľnosť:\par\medskip
\noindent\textbf{G-Eval} (LLM-as-a-judge): \emph{relevance, coherence, fluency, factual accuracy}.\par\medskip
\noindent\textbf{Perplexita} na testovacích vzorkách (nižšia je lepšia).\par\medskip
\noindent\textbf{TTFT} a \textbf{TPS} ako latencia a priepustnosť generovania.\par\medskip
\noindent\textbf{VRAM} po načítaní modelu a pri kontexte 1024 tokenov.\par\medskip
