...
\noindent\textbf{G-Eval} (LLM-as-a-judge): \emph{relevance, coherence, fluency, factual accuracy}.\par
\noindent\textbf{Perplexita} na testovacích vzorkách (nižšia je lepšia).\par
\noindent\textbf{TTFT} a \textbf{TPS} ako latencia a priepustnosť generovania.\par
\noindent\textbf{VRAM} po načítaní modelu a pri kontexte 1024 tokenov.\par
